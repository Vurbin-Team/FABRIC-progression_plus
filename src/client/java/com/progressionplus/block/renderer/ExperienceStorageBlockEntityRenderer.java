...
public class ExperienceStorageBlockEntityRenderer implements BlockEntityRenderer<ExperienceStoragePedestalEntity> {
    ...
    @Override
    public void render(ExperienceStoragePedestalEntity entity, float tickDelta, MatrixStack matrices, VertexConsumerProvider vertexConsumers, int light, int overlay) {
        ...
        if (renderEntity != null && !renderEntity.isEmpty()) {
            ...
            if (!stack.isEmpty()) {
                ...
                MinecraftClient.getInstance().getItemRenderer().renderItem(
                        stack, ModelTransformationMode.GROUND, light, overlay, matrices, vertexConsumers,
                        entity.getWorld(), 0
                );
